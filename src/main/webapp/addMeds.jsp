        ...
        <div class="bubble">
            <form action="addMed" method="post" style="background-color:white; padding:20px; border-radius:20px;">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="Price" title="Choose a valid price, #.##" pattern="^\d+\.\d{2}$" name="price" style="margin: 10px 0;" required>
                    <label for="Price">Price</label>
                </div>
                <div class="form-floating">
                    <input type="number" class="form-control" id="Quantity" min="0" name="quantity" style="margin: 10px 0;" required>
