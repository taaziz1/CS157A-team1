...
<nav class=" bg-body-tertiary navbar">
	...
	<div class="navend">
		<a class="formPath logoutButton" href="logout.jsp" >Log Out</a>
	</div>
</nav>
...
<div class="center1">
	<div class=" pharmDashBorder">
		...
		<table >
			...
			<%--Chnage it so  it so it doesnt display null if info not there--%>
			<tr>
				<th>Phone Number</th>
...
<div style="display: block;">
	...
	<div style="margin-left: 20px;"><div>
		<h4 class="navstart"> Medications</h4><div class="navend" style="margin-right:50px;">
		...
		<ul class="pharmDashBorder medStyle">
			<li>Manufacturer: <%=meds.getManufName()%> </li>
			<li>Medicine: <%=meds.getMedName()%></li>
			<li  >med_id: <%=meds.getMedId()%></li>
			<li >Price: $<%=String.format("%.2f", meds.getPrice()) %></li>
			<li >Qty: <%=meds.getQuantity()%></li>
			<div class="functionOptions">
				...
				<%--delete function--%>
				<li ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
