...
<body>
    ...
    <%--Pharmacy Name--%>
    <h1 style="width: fit-content; font-size: 2.5rem; background-color: white; margin:20px auto 0; padding:10px 25px; border-radius:80px;">
        Welcome, <%=pharmacy.getPharmacyName()%></h1>
