...
<body>
        ...
        <nav class=" bg-body-tertiary navbar">
            ...
            <div class="navend">
                ...
                <span class="navend" style="margin:0;">
                    <a class="formPath" style="text-decoration: none;" href="custDashboard.jsp"><img src="<%= customerName %>" style="width:36px;height:36px;top:-2px;"></a>
                </span>
                ...
                <div class="card-body">
                    ...
                    <%
                        ...
                        try (Connection con = Utilities.createSQLConnection();
                             PreparedStatement ps = con.prepareStatement(SEARCH_SOLD_MEDS)) {
    ...
    <%--3 Dots Edit/Delete Dropdown Menu for the Review Owner--%>
    <script>
    ...
    <%--To get API key for distance calculation--%>
    <script>
