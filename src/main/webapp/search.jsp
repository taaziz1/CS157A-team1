...
<head>
    ...
    <style>
        <%--To wrap result boxes around canvas and center them--%>
        #flexbox {
            display: flex;
            flex-wrap: wrap;
        ...
        <%--To show distance for each pharmacy--%>
        .distDisplay {
            color: grey;
            font-size: 1.2rem;
        }
        ...
        <%
            ...
            if ("Medication".equals(searchCategory) && searchQuery != null) {
                ...
                try (Connection con = Utilities.createSQLConnection();
                     PreparedStatement ps = con.prepareStatement(SEARCH_MED_SQL)) {
            ...
            //If the query was for a type
                ...
                try (Connection con = Utilities.createSQLConnection();
                     PreparedStatement ps = con.prepareStatement(SEARCH_TYPE_SQL)){
